...
public class LoginActivity extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        share = this.getSharedPreferences("sven", MODE_PRIVATE);//实例化
    ...
    public void login(View view) {
        ...
        if ("sven".equals(name.getText().toString()) && "123456".equals(password.getText()
                .toString())) {
            SharedPreferences share = super.getSharedPreferences("sven", MODE_PRIVATE);//实例化
